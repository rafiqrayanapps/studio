...
const palettes = [
  ...
  {
    name: 'غروب الشمس',
    shades: ['#FEF3C7', '#FDBA74', '#FB923C', '#F97316', '#EA580C'],
    tints: [],
  },
  {
    name: 'أخضر طبيعي',
    shades: ['#D1FAE5', '#A7F3D0', '#6EE7B7', '#34D399', '#10B981'],
    tints: [],
  },
  {
    name: 'بنفسجي أنيق',
    shades: ['#EDE9FE', '#DDD6FE', '#C4B5FD', '#A78BFA', '#8B5CF6'],
    tints: [],
  },
  {
    name: 'وردي دافئ',
    shades: ['#FCE7F3','#FBCFE8', '#F9A8D4', '#F472B6', '#EC4899'],
    tints: [],
  },
  {
    name: 'أحمر ناري',
    shades: ['#F87171', '#EF4444', '#DC2626'],
    tints: ['#FEE2E2', '#FECACA'],
  },
  {
    name: 'تركوازي منعش',
    shades: ['#5EEAD4', '#2DD4BF', '#14B8A6'],
    tints: ['#CCFBF1', '#99F6E4'],
  },
  {
    name: 'نيلي عميق',
    shades: ['#A5B4FC', '#818CF8', '#6366F1'],
    tints: ['#E0E7FF', '#C7D2FE'],
  },
  {
    name: 'رمادي محايد',
    shades: ['#9CA3AF', '#6B7280', '#4B5563'],
    tints: ['#F3F4F6', '#E5E7EB'],
  },
  {
    name: 'سماوي مشرق',
    shades: ['#67E8F9', '#22D3EE', '#06B6D4'],
    tints: ['#CFFAFE', '#A5F3FC'],
  },
];
