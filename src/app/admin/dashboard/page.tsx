                        ...
                        <CardContent>
                            <div className="mb-6">
                                ...
                                <form onSubmit={paymentMethodForm.handleSubmit(onPaymentMethodSubmit)} className="space-y-4 p-4 border rounded-lg bg-background">
                                    ...
                                    <FormField control={paymentMethodForm.control} name="icon" render={({ field }) => <FormItem><FormLabel>أيقونة (Lucide)</FormLabel><FormControl><Input placeholder="CreditCard" {...field} /></FormControl><FormDescription>ابحث عن اسم الأيقونة في موقع <a href="https://lucide.dev/icons/" target="_blank" rel="noopener noreferrer" className="text-primary underline">lucide.dev/icons</a></FormDescription><FormMessage /></FormItem>} />
