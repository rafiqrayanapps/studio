                                        ...
                                        <Form {...itemForm}>
                                            <form onSubmit={itemForm.handleSubmit(onSaveItem)} className="space-y-5 pt-4 pb-6">
                                                ...
                                                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                                    ...
                                                    <FormField control={itemForm.control} name="downloadUrl" render={({field})=><FormItem><FormLabel className="text-xs font-black">رابط التحميل</FormLabel><FormControl><Input {...field} className="rounded-xl h-12"/></FormControl><FormMessage /></FormMessage></FormItem>} />
                                                </div>
                                                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
